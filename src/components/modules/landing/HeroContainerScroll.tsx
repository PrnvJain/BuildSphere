        ...
        >
          <a href="#" className="bg-slate-800 z-[99999] no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6  inline-block">
            ...
            <div className="relative flex space-x-2 items-center z-10 rounded-full bg-background py-0.5 px-4 ring-1 ring-white/10 ">
              <span>BuildSphere Connect 2023</span>
              <svg
                width="16"
                height="16"
                viewBox="0 0 24 24"
    ...
    >
      ...
      >
        <motion.div
          ...
          className="div max-w-7xl mx-auto text-center" // Increased even more from max-w-6xl to max-w-7xl
        >
          <a href="#" className="bg-slate-800 z-[99999] no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6 inline-block">
            <span className="absolute inset-0 overflow-hidden rounded-full">
              <span className="absolute inset-0 rounded-full bg-[image:radial-gradient(75%_100%_at_50%_0%,rgba(56,189,248,0.6)_0%,rgba(56,189,248,0)_75%)] opacity-0 transition-opacity duration-500 group-hover:opacity-100"></span>
            ...
            <div className="relative flex space-x-2 items-center z-10 rounded-full bg-background py-0.5 px-4 ring-1 ring-white/10 ">
              <span>BuildSphere Connect 2025</span>
              <svg
                width="16"
                height="16"
                viewBox="0 0 24 24"
          ...
          <div className="bg-gradient-to-r from-primary to-secondary-foreground text-transparent bg-clip-text relative">
            <h1 className="text-6xl font-bold text-center md:text-[180px] z-[99999] px-6 mx-auto w-full overflow-visible">
              BuildSphere
            </h1>
          </div>
        </motion.div>
...
const Card: React.FC<CardProps> = ({ rotate, scale }) => {
  return (
    <motion.div
      ...
      className="max-w-7xl -mt-20 mx-auto h-[30rem] md:h-[40rem] w-full border-4 border-[#6C6C6C] p-6 bg-background rounded-[30px] shadow-2xl" // Increased max-width from max-w-6xl to max-w-7xl
    >
      <Image
        src="/assets/preview.png"
        alt="Banner preview"
